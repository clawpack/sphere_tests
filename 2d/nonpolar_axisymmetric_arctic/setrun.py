...
#------------------------------
    ...
    clawdata.lower[0] = -40.
    clawdata.upper[0] = 40.0

    clawdata.lower[1] = 40.0
    clawdata.upper[1] = 80.0
...
#-------------------
    ...
    geo_data.manning_coefficient = 0.  #0.025
    ...
    #   [fname]
    #rundata.qinit_data.qinitfiles.append(['ring.xyz'])
